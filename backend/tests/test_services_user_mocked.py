"""Tests for user service with mocked database."""
...
def mock_user_doc():
    ...
    return {
        ...
        "api_keys": [
            {
                "key_hash": key_hash,  # Changed from "hash" to "key_hash"
                "name": "Default",
...
@pytest.mark.asyncio
async def test_generate_new_api_key(user_service, mock_db, mock_user_doc):
