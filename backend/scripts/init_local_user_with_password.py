#!/usr/bin/env python3
"""
Script to initialize a user with username/password authentication for local testing.
"""
...
def main():
    # Configuration for local development (matching docker-compose.yml)
    MONGO_URI = "mongodb://admin:changeme-use-strong-password-in-production@localhost:27017/claudelens?authSource=admin"
    USERNAME = "admin"
    ...
    try:
        ...
        # Force connection to check if MongoDB is available
        client.server_info()
