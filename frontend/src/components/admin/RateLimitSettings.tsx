      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>
              Configure rate limits to protect your system from abuse and ensure
              fair usage
            </CardDescription>
          </div>
        ...
        <div className="mb-6">
          ...
          <div className="space-y-2">
            <RateLimitField
              ...
              onChange={(v) => handleFieldChange('http_rate_limit_enabled', v)}
              type="boolean"
        ...
        <div className="mb-6">
          ...
          <div className="space-y-2">
            ...
            <RateLimitField
              ...
              onChange={(v) => handleFieldChange('ingest_max_file_size_mb', v)}
              type="number"
              min={1}
              max={500}
              unit="MB"
        ...
        <div className="mb-6">
          ...
          <div className="space-y-2">
            ...
            <RateLimitField
              ...
              onChange={(v) => handleFieldChange('ai_rate_limit_per_minute', v)}
              type="number"
              min={0}
              max={100}
              unit="req/min"
        ...
        <div>
          ...
          <div className="space-y-2">
            <RateLimitField
              ...
              onChange={(v) => handleFieldChange('rate_limit_window_hours', v)}
              type="number"
              min={1}
              max={24}
              unit="hours"
