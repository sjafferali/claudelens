...
export const RestoreDialog: React.FC<RestoreDialogProps> = ({
  ...
  const handleRestore = () => {
    ...
    if (restoreOptions.mode === 'selective') {
    ...
    <>
        ...
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
              Configure how you want to restore this backup. Preview the
              contents below before proceeding.
            </p>
          </DialogHeader>
      ...
      {showSelectiveDialog && (
        <SelectiveRestoreDialog
          open={showSelectiveDialog}
          onOpenChange={setShowSelectiveDialog}
          backupId={backupId}
